...
% Book metadata
\title{UFFEMA:}
\date{Reference Manual Version 0.1}
\author{{\Large UFFEMA Developers}}
\publisher{Dr. A. J. Pi\~{n}a Ortega}
...
\vspace{0.1in}{\fontsize{24}{34}\selectfont \textit{Unified Framework for Electric Machine Analysis}\par}
...
Copyright \copyright\ \the\year\ \thanklesspublisher

\par\smallcaps{Powered by \thanklessauthor}
...
The Unified Framework for Electric Machines Analysis (UFFEMA) has been created to describe conventional geometries used in the design of rotating electric machines.  
