...
class StandardInnerStatorLinear(Stator):
    @property
    def type(self):
        return self._type
    ...
    def get_type(self):
        return 'StandardInnerLinear'

    def __init__(self, stator_settings):
        super(StandardInnerStatorLinear, self).__init__(stator_settings)
        self.type = self.type + 'StandardInnerLinear'
        self.length_y = stator_settings['Ly']
        self.pos_y = stator_settings['Py']
